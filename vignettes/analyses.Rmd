...
This tells us the ideal ARIMA model is a white noise model. Let's then another ARIMA model incuding a regressor that codes for the intervention.
...
In this case, the larger model which also regresses on the presence of the intervention, is statistically significantly better for our data. Wohoo.
